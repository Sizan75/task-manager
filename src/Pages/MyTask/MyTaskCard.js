	...
	<div className="flex flex-col justify-between p-6 space-y-8">
		<div className="space-y-2">
            ...
            <div className='flex justify-between'>
                ...
                <button onClick={() => handleDelete(_id)} className="flex items-center justify-center w-1/3 p-3 font-semibold tracking-wide rounded-md bg-violet-400 ">Update</button>
            </div>
		</div>
